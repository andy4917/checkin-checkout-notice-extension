...
- surfaceId: `customer-checkout-notice`
- menuPath: 홈 > 고객 안내문 > 체크아웃 안내문
- expected image: `docs/product-surface-targets/customer-checkout-notice/expected.png` (repo-boundary expected image contract)
