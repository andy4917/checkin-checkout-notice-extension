...
- surfaceId: `customer-fee-notice`
- menuPath: 홈 > 고객 안내문 > 각종 요금 관련 안내문
- expected image: `docs/product-surface-targets/customer-fee-notice/expected.png` (repo-boundary expected image contract)
...
- smoke access: 고객 안내문 > 각종 요금 관련 안내문
