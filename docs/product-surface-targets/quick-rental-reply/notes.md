...
- surfaceId: `quick-rental-reply`
- menuPath: 홈 > 빠른 문의 답변 > 물품 대여 문의
- expected image: `docs/product-surface-targets/quick-rental-reply/expected.png` (repo-boundary expected image contract)
...
- smoke access: 빠른 문의 답변 > 물품 대여 문의
