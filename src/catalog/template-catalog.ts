...
const TEMPLATE_METADATA: Record<string, Omit<CatalogSourceMetadata, "icon">> = {
  ...
  "quick-breakfast-inquiry": {
    menuId: "QUICK_REPLY",
    typeId: "breakfast_inquiry",
    summary: "조식 미제공 지점 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::조식 문의_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-invoice-inquiry": {
    menuId: "QUICK_REPLY",
    typeId: "invoice_inquiry",
    summary: "예약 플랫폼 인보이스 문의 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::인보이스 문의_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-cancellation-within-week": {
    menuId: "QUICK_REPLY",
    typeId: "cancellation_inquiry",
    summary: "체크인 1주 이내 취소 및 환불 정책 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::체크인 1주이내 취소 문의_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-laundry-service-inquiry": {
    menuId: "QUICK_REPLY",
    typeId: "laundry_service_inquiry",
    summary: "세탁 서비스 이용 조건과 접수 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::세탁 서비스 문의_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-kakao-channel-connect": {
    menuId: "QUICK_REPLY",
    typeId: "kakao_channel_connect",
    summary: "문의 지점 확인 후 카톡 채널 연결 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::카톡 채널 문의 연결_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-kakao-channel-closing": {
    menuId: "QUICK_REPLY",
    typeId: "kakao_channel_closing",
    summary: "추가 문의 가능 안내와 상담 마무리",
    sourceRefs: ["빠른 답변형_탬플릿.zip::카톡 채널 문의 마무리_4개국어.md"],
    duplicateGroupId: null,
  },
  "quick-nearby-restaurant-inquiry": {
    menuId: "QUICK_REPLY",
    typeId: "nearby_restaurant",
    summary: "선릉 인근 식당 지도 링크 안내",
    sourceRefs: ["빠른 답변형_탬플릿.zip::@ 근처 식당 문의.md"],
    duplicateGroupId: null,
  },
  "full-cleaning-notice": {
    menuId: "CUSTOMER_NOTICE",
    typeId: "cleaning_notice",
    summary: "퇴실 전 전체 청소 예정과 회신 마감 안내",
    sourceRefs: ["고객 안내형_4개국어_템플릿본.zip::09_전체청소_안내.md"],
...
const TEMPLATE_TYPE_ICONS: Readonly<Record<TemplateTypeId, string>> = Object.freeze({
  ...
  breakfast_inquiry: "restaurant",
  invoice_inquiry: "receipt_long",
  cancellation_inquiry: "event_busy",
  laundry_service_inquiry: "local_laundry_service",
  kakao_channel_connect: "forum",
  kakao_channel_closing: "done_all",
  nearby_restaurant: "restaurant_menu",
